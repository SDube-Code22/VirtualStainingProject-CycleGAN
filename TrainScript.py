...
BASE_DIR_Grey = "/users/thatomakena/workspace/Project_Datasets_Thato/Unstained" # Path to the unstained images.
BASE_DIR_IHC = "/users/thatomakena/workspace/Project_Datasets_Thato/IHC" # Path to the IHC (Immunohistochemistry) stained images.
